      ...
      <MenuListWrapper>
        <MenuListElement>
          ...
          <Link href={'/console/docs'}>
            <Text  color={pallette.white}>Docs</Text>
          </Link>
        </MenuListElement>
        <MenuListElement>
          <svg
          ...
          <Link href="/trial">
            <Text  color={pallette.white}>Trial</Text>
          </Link>
        </MenuListElement>
          {isUserLoggedIn &&
        <MenuListElement>
          <svg xmlns="http://www.w3.org/2000/svg" fill="" stroke="white" viewBox="0 0 24 24" className="humbleicons hi-logout"><path xmlns="http://www.w3.org/2000/svg" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12h-9.5m7.5 3l3-3-3-3m-5-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h5a2 2 0 002-2v-1"/></svg>
          <Link href="/api/auth/logout">
            <Text color={pallette.white}>logout</Text>
          </Link>
        </MenuListElement>
        }
      </MenuListWrapper>
